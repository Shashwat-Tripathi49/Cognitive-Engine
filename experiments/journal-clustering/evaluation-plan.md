...
> _Could the initial Phase 1 reflection be generated by a generic LLM reading only the last week's journal entries?_
...
4. **Longitudinal Delta Explanation:** The LLM prompt is strictly constrained to explaining the _difference_ or _evolution_ between the past fragment and current fragment.
