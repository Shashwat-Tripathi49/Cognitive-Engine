...
> _"A Reflection cannot exist without Evidence."_
...
> _"Evidence cannot reference deleted or non-existent fragments."_
...
> _"Confidence cannot originate from an LLM."_
...
> _"Discovery must be deterministic whenever possible."_
...
> _"Memory content never mutates."_
...
> _"Graph entities are versioned, never overwritten."_
...
> _"Patterns require minimum supporting evidence."_
...
> _"LLMs explain validated evidence; LLMs do not invent facts."_
...
> _"Vector storage and Knowledge Graph topology must remain decoupled."_
...
> _"Memory decay never destroys user thoughts."_
